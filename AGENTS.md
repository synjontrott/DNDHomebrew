...
11. **Species Traits & Benchmarks (August 2026):** Genempriea updated to 35ft base speed + *Overclocked Actuators* (Bonus Action Dash PB/LR). Plunesako expanded to grant dual skills + 1 Origin Feat of choice. Krenpowen/Tenebrie upgraded with Darkvision 60ft, dual skills (*Cluster Discipline*), *Ninjonian Reflexes* (Advantage on Initiative), and *Shadow Stride* (Bonus Action 30ft shadow teleport PB/LR), achieving 100% power parity with Plunesako and Genempriea.
